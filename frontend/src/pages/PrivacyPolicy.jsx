...
export default function PrivacyPolicy() {
  ...
  return (
    <div className="lp-root">
      ...
      />
      <Navbar /><section className="page-hero">
      ...
      </section><section className="lp-how privacy-body-section">
        <div className="privacy-content-container"><div className="privacy-block">
      ...
      </section><footer className="lp-footer">
