...
export function TypingKeyboard({
  className = "",
  autoTypeText = "AcePrep. Ace your next interview with AI-powered mock sessions and real-time feedback.       ",
  typingSpeed = [40, 120],
  scale = 0.8,
  accentColor = "#a85560",
  ...
  return (
    <div className={cn("tk-container", className)} {...props}>
      <style>{`
        ...
        .tk-keyboard__front { width: 500px; height: 25px; transform: rotateX(-90deg) translateZ(80px); background-color: #52292f; }
        ...
        .tk-screen {
          ...
          box-shadow:
            ...
            0 0 12px color-mix(in srgb, ${accentColor} 70%, transparent),
            0 0 20px color-mix(in srgb, ${accentColor} 60%, transparent),
            0 0 35px color-mix(in srgb, ${accentColor} 50%, transparent),
            0 0 50px color-mix(in srgb, ${accentColor} 40%, transparent);
          animation: tk-screen-flicker 1.2s ease-in alternate infinite;
        }
        ...
        .tk-key__front { width: 30px; height: 8px; transform: rotateX(-90deg) translateZ(13.5px); background-color: #61343a; }
        ...
        .tk-key__bottom { width: 30px; height: 27px; transform: rotateY(180deg) translateZ(4px); background-color: #61343a; }
        .tk-key__bottom--w2 { width: 60px; }
        .tk-key__bottom--w3 { width: 90px; }
        .tk-key__bottom--w6 { width: 195px; }

        .tk-key__right { width: 8px; height: 27px; transform: rotateY(90deg) translateZ(15px); background-color: #61343a; }
        ...
        .tk-key__left {
          ...
          background-image: linear-gradient(to bottom, #7d4047, #52292f);
        }
